...
trait AuditLogProvider extends EventProducer with AWSMessageEventJsonSupport {
  ...
  def auditLog(s3Request: S3Request, httpRequest: HttpRequest, user: String, awsRequest: AWSRequest, responseStatus: StatusCode)(implicit id: RequestId): Future[Done] = {
