...
case class UserRawJson(userName: String, userGroups: Set[String], accessKey: String, secretKey: String)

case class User(userName: UserName, userGroups: Set[UserGroup], accessKey: AwsAccessKey, secretKey: AwsSecretKey)
